                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full bg-black hover:bg-neutral-800 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-black/10 active:scale-[0.98] flex items-center justify-center gap-2 mt-6 border border-neutral-800 cursor-pointer"
                    >
                      {loading ? (
                  ...
                  {/* Switch option directly beneath the action button */}
                  <div className="mt-4 text-center">
                    <button
                      ...
                      className="text-sage-600 dark:text-white/80 hover:text-sage-800 dark:hover:text-white text-sm font-semibold underline focus:outline-none cursor-pointer"
                    >
                  ...
                  <div className="mt-6 flex flex-col gap-3">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="w-full bg-white dark:bg-neutral-800 border border-sage-200 dark:border-neutral-700 hover:bg-sage-50 dark:hover:bg-neutral-700 text-sage-800 dark:text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2 cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="w-full bg-[#24292e] hover:bg-[#2f363d] text-white font-semibold py-3 rounded-xl transition-colors flex items-center justify-center gap-2 cursor-pointer"
                    >
